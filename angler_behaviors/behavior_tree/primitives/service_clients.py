...
Note from Evan: This is a direct port from this PR:
https://github.com/splintered-reality/py_trees_ros/pull/215
I want to use this, but don't feel like building yet another package
from source. This will be removed when the PR is merged.
"""
